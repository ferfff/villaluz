  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> > 
    <div class="page-box">
      ...
      <div class="content-bttn">     
        <a href="<?php get_permalink() ;?>" class="blogbutton-small hvr-sweep-to-right" title="<?php esc_attr_e( 'Read More', 'ts-photography' ); ?>"><?php echo esc_html(get_theme_mod('ts_photography_button_text','Read More'));?><span class="screen-reader-text"><?php esc_html_e( 'Read More','ts-photography' );?></span></a>
      </div>
    </div>
  </article>
</div>